...
$Terminal | ForEach-Object {$_.Header | Add-Member -MemberType NoteProperty -Name "UA" -Value "" -Force}
$Terminal | ForEach-Object {$_.Description | Add-Member -MemberType NoteProperty -Name "UA" -Value "" -Force}
# $Terminal | Where-Object -FilterScript {$_.ChildElements.ChildDescription} | ForEach-Object {$_.ChildElements.ChildDescription | Add-Member -MemberType NoteProperty -Name "UA" -Value "" -Force}
